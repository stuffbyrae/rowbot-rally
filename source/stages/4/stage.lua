...
function race:stage_init()
    assets.image_stage = gfx.imagetable.new('stages/4/stage')
    ...
    assets.trees = gfx.imagetable.new('stages/4/tree')
    assets.trunks = gfx.imagetable.new('stages/4/trunk')
    assets.treetops = gfx.imagetable.new('stages/4/treetop')
    assets.bushes = gfx.imagetable.new('stages/4/bush')
    assets.bushtops = gfx.imagetable.new('stages/4/bushtop')
