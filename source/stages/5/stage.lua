...
function race:stage_init()
    assets.image_stage = gfx.imagetable.new('stages/5/stage')
    ...
    assets.trees = gfx.imagetable.new('stages/5/tree')
    assets.trunks = gfx.imagetable.new('stages/5/trunk')
    assets.treetops = gfx.imagetable.new('stages/5/treetop')
    assets.bushes = gfx.imagetable.new('stages/5/bush')
    assets.bushtops = gfx.imagetable.new('stages/5/bushtop')
