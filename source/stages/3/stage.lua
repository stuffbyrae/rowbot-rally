...
function race:stage_init()
    assets.image_stage = gfx.imagetable.new('stages/3/stage')
    ...
    assets.trees = gfx.imagetable.new('stages/3/tree')
    assets.trunks = gfx.imagetable.new('stages/3/trunk')
    assets.treetops = gfx.imagetable.new('stages/3/treetop')
    assets.bushes = gfx.imagetable.new('stages/3/bush')
    assets.bushtops = gfx.imagetable.new('stages/3/bushtop')
    ...
    newmusic('audio/music/stage3', true) -- Adding new music
    music:pause()
end
