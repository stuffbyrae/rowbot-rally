...
function tutorial:init(...)
    ...
    assets = { -- All assets go here. Images, sounds, fonts, etc.
        ...
        image_stage = gfx.imagetable.new('stages/tutorial/stage'),
        image_stagec = gfx.image.new('stages/tutorial/stagec'),
        trees = gfx.imagetable.new('stages/tutorial/tree'),
        trunks = gfx.imagetable.new('stages/tutorial/trunk'),
        treetops = gfx.imagetable.new('stages/tutorial/treetop'),
        bushes = gfx.imagetable.new('stages/tutorial/bush'),
        bushtops = gfx.imagetable.new('stages/tutorial/bushtop'),
        umbrella = gfx.image.new('stages/tutorial/umbrella'),
