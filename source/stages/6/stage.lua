...
function race:stage_init()
    assets.image_stage = gfx.imagetable.new('stages/6/stage')
    ...
    assets.caustics = gfx.imagetable.new('stages/6/caustics')
    assets.trees = gfx.imagetable.new('stages/6/tree')
    assets.trunks = gfx.imagetable.new('stages/6/trunk')
    assets.treetops = gfx.imagetable.new('stages/6/treetop')
    assets.bushes = gfx.imagetable.new('stages/6/bush')
    assets.bushtops = gfx.imagetable.new('stages/6/bushtop')
