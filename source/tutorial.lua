...
function tutorial:init(...)
    ...
    assets = { -- All assets go here. Images, sounds, fonts, etc.
        ...
        trees = gfx.imagetable.new('images/race/stages/tutorial/tree'),
        trunks = gfx.imagetable.new('images/race/stages/tutorial/trunk'),
        treetops = gfx.imagetable.new('images/race/stages/tutorial/treetop'),
        bushes = gfx.imagetable.new('images/race/stages/tutorial/bush'),
        bushtops = gfx.imagetable.new('images/race/stages/tutorial/bushtop'),
