...
function stats:init(...)
    ...
    assets = { -- All assets go here. Images, sounds, fonts, etc.
        ...
        image_ticker = gfx.image.new(481, 20, gfx.kColorWhite),
    }
    ...
    -- The background callback is in its own function here, so that it can be refreshed if the 'metric' value changes.
    function draw_stats_background()
    ...
    draw_stats_background() -- ...and let's tee that up.
